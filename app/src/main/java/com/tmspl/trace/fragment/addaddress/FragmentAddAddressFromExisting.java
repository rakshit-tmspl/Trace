...
public class FragmentAddAddressFromExisting extends Fragment {
                    ...
                    try {
                        ...
                        if (jobj1.has("error")) {
                            ...
                            if (jobj1.getString("status").equals("1")) {
                                ...
                                AddressAdapter addressAdapter = new AddressAdapter(context, R.layout.list_view_item_address, AddressList, FragmentAddAddressFromExisting.listPosition);
