...
public class RiderRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RiderRegistrationActivity.this;
        InitUI();
        InitAction();
        InitConnection();
    }
    ...
    private void InitUI() {
        ...
        rider_registration = (ImageView) findViewById(R.id.rider_registration);
    ...
    private void InitAction() {
        ...
        rider_registration = (ImageView) findViewById(R.id.rider_registration);
        rider_registration.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                gbitmap = BitmapFactory.decodeResource(context.getResources(),
                        R.drawable.rider_registration);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            ...
            rider_registration.setImageURI(data.getData());
        } else if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            Bitmap croped_pic = (Bitmap) data.getExtras().get("data");
            rider_registration.setImageBitmap(croped_pic);
        } else if (requestCode == 0) {
            Bitmap bitmp_user_img = BitmapFactory.decodeResource(getResources(), R.drawable.rider_registration);
            rider_registration.setImageBitmap(bitmp_user_img);
        }
        rider_registration.buildDrawingCache();
        gbitmap = rider_registration.getDrawingCache();
    }

    public void InitConnection() {
        httphelper = new HttpHelper(RiderRegistrationActivity.this);
        utility = new Utility(RiderRegistrationActivity.this);
    ...
    public class check_otp extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Log.e("Response RIDER", "onPostExecute: " + result);
            if (pd.isShowing())
                pd.dismiss();
            try {
