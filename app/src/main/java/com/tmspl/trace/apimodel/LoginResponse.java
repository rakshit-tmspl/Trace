...
public class LoginResponse {
    ...
    private LoginNewResponse.ResponseJsonBean responseJson;
    ...
    public LoginNewResponse.ResponseJsonBean getResponseJson() {
        return responseJson;
    }

    public void setResponseJson(LoginNewResponse.ResponseJsonBean responseJson) {
    ...
    public static class ResponseJsonBean {
        ...
        private List<LoginNewResponse.ResponseJsonBean.RiderQueryResultBean> riderQueryResult;
        @SerializedName("user_query_result")
        private List<LoginNewResponse.ResponseJsonBean.UserQueryResultBean> userQueryResult;

        public static LoginNewResponse.ResponseJsonBean objectFromData(String str) {

            return new Gson().fromJson(str, LoginNewResponse.ResponseJsonBean.class);
        }
        ...
        public List<LoginNewResponse.ResponseJsonBean.RiderQueryResultBean> getRiderQueryResult() {
            return riderQueryResult;
        }

        public void setRiderQueryResult(List<LoginNewResponse.ResponseJsonBean.RiderQueryResultBean> riderQueryResult) {
            this.riderQueryResult = riderQueryResult;
        }

        public List<LoginNewResponse.ResponseJsonBean.UserQueryResultBean> getUserQueryResult() {
            return userQueryResult;
        }

        public void setUserQueryResult(List<LoginNewResponse.ResponseJsonBean.UserQueryResultBean> userQueryResult) {
        ...
        public static class RiderQueryResultBean {
            ...
            public static LoginNewResponse.ResponseJsonBean.RiderQueryResultBean objectFromData(String str) {

                return new Gson().fromJson(str, LoginNewResponse.ResponseJsonBean.RiderQueryResultBean.class);
            }
        ...
        public static class UserQueryResultBean {
            ...
            public static LoginNewResponse.ResponseJsonBean.UserQueryResultBean objectFromData(String str) {

                return new Gson().fromJson(str, LoginNewResponse.ResponseJsonBean.UserQueryResultBean.class);
            }
